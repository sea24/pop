...
$mailbox = new Mailbox(
    '{imap.163.com:993/imap/ssl}', // IMAP server and mailbox folder
    'q1a2z30025@163.com', // Username for the before configured mailbox
    'HAHQVURGBQIGLQUH', // Password for the before configured username
