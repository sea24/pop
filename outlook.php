...
$mailbox = new Mailbox(
    '{outlook.office365.com:993/imap/ssl}', // IMAP server and mailbox folder
    'zhongkoala@outlook.com', // Username for the before configured mailbox
    'ying1013..', // Password for the before configured username
